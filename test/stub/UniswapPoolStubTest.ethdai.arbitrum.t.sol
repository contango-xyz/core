...
contract UniswapPoolStubETHDAIArbitrumTest is UniswapPoolStubTest, WithArbitrum {
    ...
    function setUp() public override {
        ...
        // Arbitrum: token0=WETH, token1=DAI
        sut = new UniswapPoolStub(token0, token1, oracle, false, 1e18);
    ...
    function testSwapZeroForOneExactInput() public {
        AssertionData memory assertionData =
            AssertionData({expectedAmount0Delta: 1 ether, expectedAmount1Delta: -999e18, repaymentToken: WETH});
